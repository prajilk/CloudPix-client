...
const LoadingButton = ({ loading, value, onClickFunction, disabled, width }) => {
    return (
        <button
            ...
            {
                loading ?
                    <svg aria-hidden="true" role="status" className="inline w-6 h-6 mr-3 text-violet-500 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
