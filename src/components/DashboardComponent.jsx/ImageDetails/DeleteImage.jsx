...
const DeleteImage = ({ imageId }) => {
    ...
    return (
        <div className='flex items-center p-3 py-2 justify-between font-montserrat text-sm font-semibold'>
            <Toaster />
            ...
            <button
                ...
                {
                    loading ?
                        <svg aria-hidden="true" role="status" className="inline w-4 h-4 text-violet-500 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
